  ...
  const confirmToken = async () => {
    ...
    if (user_id) {
      NotifyUser(
        ...
        "User validated, you can change password now"
      );
      ...
      NotifyUser(
        ...
        "Link expired or incorrect, please try again"
      );
    }
  };
          ...
          <Formik
            ...
            onSubmit={async (values, actions) => {
              ...
              if (response.success) {
                ...
                NotifyUser(
                  NOTIFICATION_TYPE.ERR,
                  `something went wrong, please try again later, error: ${response.message}`
                );
              }
            }}
          >
            <Form>
              ...
              >
                <Typography variant="button">Change the password</Typography>
              </Button>
            </Form>
          </Formik>
        </Box>
